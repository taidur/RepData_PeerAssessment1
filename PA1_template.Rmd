...
````
**The interval `r max_interval$interval` contains the maximum number of steps `r max_interval$mean`.**
...
There are currently `r count_na` rows with NA values in out data frame. Because missing values may introduce bias into calculations  NA values will be replaced by mean of the same 5-minute inteval.
...
````
 ...
 - **Mean steps per day  `r imp_mean_steps_per_day `**
 - **Median steps per day `r imp_median_steps_per_day` **
...
------------------- | -----------------------
Mean steps per day `r mean_steps_per_day `| Mean steps per day `r imp_mean_steps_per_day `
Medain steps per day `r median_steps_per_day ` | Median steps per day `r imp_median_steps_per_day `
